...
5. **토큰 발급 및 복귀**: 진입이 허용되면 토큰을 발급받아 쿠키에 저장한 뒤 원래 `website`로 바로 복귀
...
sequenceDiagram
    ...
    alt 진입 허용됨
        ...
        alt 유효한 토큰 있음
            ...
            Redis-->>Queue: 현재 순번
            Queue-->>User: waiting-room.html 반환
        end
